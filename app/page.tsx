      ...
      <header className="bg-white dark:bg-gray-950 text-gray-900 dark:text-white pt-20 pb-36 px-4 relative overflow-hidden transition-colors duration-700">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <p className="text-lg md:text-xl text-gray-500 dark:text-gray-400 mb-14 max-w-2xl mx-auto font-medium leading-relaxed animate-in fade-in slide-in-from-bottom-12 duration-1000">
            Australia's premier risk-free lottery engine. Track your numbers, receive automated alerts, and master the odds.
          </p>
      ...
      <main className="max-w-6xl mx-auto px-6 -mt-20 relative z-20 flex-grow pb-40">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-36">
          {latestResults.length > 0 ? latestResults.map((res, i) => {
            ...
            return (
              <div key={i} className="bg-white/95 dark:bg-gray-900/95 p-8 rounded-[2.5rem] shadow-xl border border-gray-100 dark:border-white/5 backdrop-blur-2xl transition-all duration-500 hover:-translate-y-1.5 group overflow-hidden">
        ...
        <section className="mb-40">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 dark:text-white uppercase tracking-tighter">System Features</h2>
            <div className="w-24 h-1.5 bg-gradient-to-r from-indigo-600 to-emerald-500 mx-auto mt-4 rounded-full shadow-sm" />
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              { icon: 'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z', title: 'Risk Neutral', desc: 'Zero financial exposure. Test your personal lucky numbers against real-world probability.' },
              { icon: 'M22 11.08V12a10 10 0 1 1-5.93-9.14 M22 4 12 14.01 9 11.01', title: 'Auto-Sync', desc: 'Results are verified automatically against official node data the moment they are published.' },
              { icon: 'M12 8v4l3 3 M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z', title: 'Historical Audit', desc: 'Every tracked set is permanently archived, allowing you to review performance over years of draws.' }
            ].map((feature, i) => (
        ...
        {/* Global Network Section - Scaled Down */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="text-left relative z-10">
              ...
              <h2 className="text-5xl md:text-6xl font-black mb-8 uppercase tracking-tighter leading-[0.9]">
                Platform <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-blue-400 italic">Statistics</span>
              </h2>
              <p className="text-gray-400 text-lg mb-4 font-medium leading-relaxed max-w-md">
                Aggregating simulation data across the network, validated against live lottery blocks.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 relative z-10">
              <div className="bg-white/5 p-8 rounded-[2.5rem] border border-white/10 backdrop-blur-xl group-hover:border-indigo-500/30 transition-all duration-700 text-center shadow-lg">
                <p className="text-[10px] font-black text-gray-500 uppercase tracking-[0.3em] mb-4">Cycles Run</p>
              ...
              <div className="bg-white/5 p-8 rounded-[2.5rem] border border-white/10 backdrop-blur-xl group-hover:border-emerald-500/30 transition-all duration-700 text-center shadow-lg">
                <p className="text-[10px] font-black text-gray-500 uppercase tracking-[0.3em] mb-4">Terminals</p>
        ...
        <section className="text-center py-24 bg-indigo-600 rounded-[3.5rem] text-white shadow-2xl mb-24 relative overflow-hidden group">
          ...
          <div className="relative z-10 px-6">
            <h2 className="text-5xl md:text-7xl font-black mb-8 uppercase tracking-tighter leading-[0.9] group-hover:scale-[1.01] transition-transform duration-700 italic">Verify your destiny.</h2>
            <p className="text-indigo-100 mb-14 font-medium text-xl opacity-90 italic max-w-xl mx-auto">Access Australia's most advanced lottery simulation grid.</p>
