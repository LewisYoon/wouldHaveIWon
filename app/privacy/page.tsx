  ...
  return (
    <div className="bg-white dark:bg-gray-950 min-h-screen text-gray-900 dark:text-gray-100 selection:bg-indigo-500 selection:text-white">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-24 text-left">
        <article className="prose prose-base sm:prose-lg prose-indigo dark:prose-invert max-w-none">
          <header className="mb-8 sm:mb-12 border-b border-gray-100 dark:border-white/5 pb-6 sm:pb-8">
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-black uppercase tracking-tighter mb-3 sm:mb-4 leading-tight">
              Privacy <span className="text-indigo-600 dark:text-indigo-400 italic">Policy</span>
            </h1>
            <p className="text-[10px] sm:text-sm font-black text-gray-400 uppercase tracking-widest">Last Updated: March 10, 2026</p>
          </header>

          <div className="space-y-8 sm:space-y-10 text-base sm:text-lg text-gray-600 dark:text-gray-300 font-medium leading-relaxed">
            <section>
              <p>
            ...
            <section className="space-y-3 sm:space-y-4">
              <h2 className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white uppercase tracking-tight">1. Information We Collect</h2>
              <p>
            ...
            <section className="space-y-3 sm:space-y-4">
              <h2 className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white uppercase tracking-tight">2. How We Use Your Information</h2>
            ...
            <section className="space-y-3 sm:space-y-4">
              <h2 className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white uppercase tracking-tight">3. Log Files & Cookies</h2>
              <p>
            ...
            <section className="space-y-3 sm:space-y-4">
              <h2 className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white uppercase tracking-tight">4. Google OAuth & Advertising</h2>
              <p>
            ...
            <section className="space-y-3 sm:space-y-4">
              <h2 className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-white uppercase tracking-tight">5. Data Protection Rights</h2>
              <p>
            ...
            <section className="p-6 sm:p-8 bg-gray-50 dark:bg-white/5 rounded-2xl sm:rounded-3xl border border-gray-100 dark:border-white/5 mt-12 sm:mt-16">
              <h2 className="text-xl sm:text-2xl font-black text-gray-900 dark:text-white uppercase mb-3 sm:mb-4">Contact Information</h2>
