  ...
  return (
    <div className="fixed inset-0 z-[10000] overflow-y-auto">
      ...
      <div className="flex min-h-full items-center justify-center p-4 md:p-6 text-center">
        <div className="w-full max-w-md transform overflow-hidden rounded-[2.5rem] bg-white dark:bg-gray-900 text-left align-middle shadow-2xl border border-gray-100 dark:border-white/5 transition-all animate-in fade-in zoom-in-95 duration-300 flex flex-col relative z-10 my-8">
